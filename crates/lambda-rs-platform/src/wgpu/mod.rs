...
impl CommandEncoder {
  ...
  /// Begin a render pass that clears the color attachment to the provided RGBA color.
  ///
  /// This helper avoids exposing raw `wgpu` color/operation types to higher layers.
  pub fn begin_render_pass_clear<'view>(
    &'view mut self,
    label: Option<&str>,
    view: &'view surface::TextureViewRef<'view>,
    color: [f64; 4],
    ...
    return self.begin_render_pass(label, view, ops);
  }
