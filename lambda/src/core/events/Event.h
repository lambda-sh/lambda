...
#ifndef LAMBDA_SRC_CORE_EVENTS_EVENT_H_
#define LAMBDA_SRC_CORE_EVENTS_EVENT_H_
...
class EventDispatcher {
 ...
 public:
  ...
  /// @brief Dispatch an event to be handled if it matches the class Event
...
#endif  // LAMBDA_SRC_CORE_EVENTS_EVENT_H_
