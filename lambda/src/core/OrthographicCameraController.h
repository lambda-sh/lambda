#ifndef LAMBDA_SRC_CORE_ORTHOGRAPHICCAMERACONTROLLER_H_
#define LAMBDA_SRC_CORE_ORTHOGRAPHICCAMERACONTROLLER_H_
...
#endif  // LAMBDA_SRC_CORE_ORTHOGRAPHICCAMERACONTROLLER_H_
