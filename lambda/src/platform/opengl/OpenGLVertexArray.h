#ifndef LAMBDA_SRC_PLATFORM_OPENGL_OPENGLVERTEXARRAY_H_
#define LAMBDA_SRC_PLATFORM_OPENGL_OPENGLVERTEXARRAY_H_
...
#endif  // LAMBDA_SRC_PLATFORM_OPENGL_OPENGLVERTEXARRAY_H_
